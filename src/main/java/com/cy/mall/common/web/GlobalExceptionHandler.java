package com.cy.mall.common.web;
...
/**
 * @ControllerAdvice 描述的类为全局异常处理类 假如XxxController类的方法出现了异常，
...
public class GlobalExceptionHandler {
	...
	public JsonResult doHandleShiroException(ShiroException e) {
		...
		r.setState(0);
		if (e.getClass().getSimpleName().equals("AuthenticationException")) {
	...
	/**
	 * @ExceptionHandler 注解描述的方法为控制层的异常处理方法,此注解 中传入的异常类型，为它描述的方法可以处理的异常。
	 * @param e
	 * @return
	 */
